...
func (m *Manager) RegisterTableModel() {
	...
	m.models = append(m.models, &model.TenantEnvServiceSchedulingLabel{})
	m.models = append(m.models, &model.TenantEnvServiceSchedulingNode{})
	m.models = append(m.models, &model.TenantEnvServiceSchedulingToleration{})
	m.models = append(m.models, &model.TenantEnvServiceLabel{})
