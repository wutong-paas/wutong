...
func (i *ImageShareItem) ShareService() error {
	...
	if syncImage {
		hubuser, hubpass := chaos.GetImageUserInfoV2(i.LocalImageName, i.LocalImageUsername, i.LocalImagePassword)
		...
		user, pass := chaos.GetImageUserInfoV2(i.ImageName, i.ShareInfo.ImageInfo.HubUser, i.ShareInfo.ImageInfo.HubPassword)
