	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WutongV1alpha1().ThirdComponents(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WutongV1alpha1().ThirdComponents(namespace).Watch(context.TODO(), options)
			},
		},
		&wutongv1alpha1.ThirdComponent{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *thirdComponentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wutongv1alpha1.ThirdComponent{}, f.defaultInformer)
}
