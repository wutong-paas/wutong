...
type FakeComponentDefinitions struct {
	Fake *FakeWutongV1alpha1
	ns   string
}

var componentdefinitionsResource = schema.GroupVersionResource{Group: "wutong.io", Version: "v1alpha1", Resource: "componentdefinitions"}

var componentdefinitionsKind = schema.GroupVersionKind{Group: "wutong.io", Version: "v1alpha1", Kind: "ComponentDefinition"}
