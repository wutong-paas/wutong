...
import (
	...
	"github.com/wutong-paas/wutong/mq/api"
...
func Run(s *option.MQServer) error {
	...
	keepalive, err := discover.CreateKeepAlive(etcdClientArgs, "wutong_mq", s.Config.HostName, s.Config.HostIP, s.Config.APIPort)
	if err != nil {
		return err
	}
